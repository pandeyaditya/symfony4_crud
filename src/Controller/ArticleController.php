...
class ArticleController extends Controller{
	...
	*/
	...
	public function index(){
		...
		return $this->render('articles/index.html.twig',array('articles'=> $article));
	}
	...
	*/
	public function save(){
		...
		$article->setBody('This is body of article');

		$entityManager->persist($article);
		$entityManager->flush();
		return new Response('Saved article id '.$article->getId());
	}
